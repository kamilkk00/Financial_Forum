...
class Post(models.Model):
    ...
    CATEGORY_CHOICES = [ 
        ('zakladanie_firmy', 'Company Formation'),
        ('finance_inwestycje', 'Finance and Investments'),
        ('marketing_sprzedaz', 'Marketing and Sales'),
        ('zarządzanie_operacje', 'Management and Operations'),
        ('prawo_regulacje', 'Law and Regulations'),
        ('rozwoj_osobisty', 'Personal Development and Networking'),
        ('inne', 'Others')
    ]
